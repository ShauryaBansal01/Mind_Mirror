        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-4 max-w-md">
              AI-powered mental wellness journaling platform that helps you reflect on your thoughts, 
              detect cognitive distortions, and develop healthier thinking patterns.
            </p>
